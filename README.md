...
> * подготовленные данные о землетрясениях в регионах, обогащённые набором параметров, описанных в [1], сгруппированные по разным временным промежуткам (...);
> * функции для расчёта сейсмических индикаторов *Adeli & Panakkat* (файл .ipynb), а также пример их использования для обработки данных о землетрясениях.

<h3>Reyes et al. seismicity indicators</h3>

> Папка "Reyes et al. seismicity indicators" содержит:
> * подготовленные данные о землетрясениях в регионах, обогащённые набором параметров, описанных в [2], сгруппированные по разным временным промежуткам (...);
> * функции для расчёта сейсмических индикаторов *Reyes et al.* (файл .ipynb), а также пример их использования для обработки данных о землетрясениях.
